...
export class UserComponent implements OnInit {
  ...
  private Saveurl = this.Url.appconstant + this.Url.userSaveApi;
  ...
  private GetPagination = this.Url.appconstant + this.Url.userPagination;
  constructor(private makeapi: WebserviceService, private Formbuilder: FormBuilder, private http: Http, private Url: UrlService, private router: Router) {
  ...
  UserList() {
    // this.loading = true
    var reqdata =  "page=" +this.currentPage
  ...
  SubmitUser() {
    ...
    if ((getdata.name == null || getdata.name == "") && (getdata.emailid == null || getdata.emailid == "") &&
      (getdata.phonenumber == null || getdata.phonenumber == "") &&   (getdata.employeecode == null || getdata.employeecode == "")) {
      ...
      getform.dob = $("#datedobs").val();
      var reqdata = "userDetails=" + JSON.stringify(getform);
      // debugger
      return this.makeapi.method(this.Saveurl, reqdata, "post")
        .subscribe(data => {
          ...
          if (data.status == 'success') {
            ...
            this.UserList()
            let reqdata = "filename=" +  this.Userid + "_" +this.fileName
            return this.makeapi.method(this.GetImageurl + reqdata, "", "get")
              .subscribe(data => {
                ...
                $.notify("User details added successfully!!!", "success");
                this.UserForm.reset();
  ...
  PaginationCount() {
    ...
    return this.makeapi.method(this.GetPagination, "", "post")
      .subscribe(data => {
  ...
  PaginationCountSearch() {
    ...
    return this.makeapi.method(this.GetPagination, getdata, "post")
      .subscribe(data => {
