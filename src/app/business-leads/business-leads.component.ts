...
@Component({
  ...
  styleUrls: ['./business-leads.component.css']
})
export class BusinessLeadsComponent implements OnInit {
p2=1
businessleadcontactform:FormGroup
  private Listurl = this.Url.appconstant+this.Url.getAllBusinessContactsApi;
  private DownloadUrl = this.Url.appconstant + this.Url.BusiDownloadsApi;
  ...
  private Paginationurl = this.Url.appconstant + this.Url.CorporatePaginationApi;
 ...
 this.LeadList()
  ...
  showTypes(event) {
    ...
    $("#importActionsbl").slideToggle("fast");
  
  }
  downloadexcel() {
    var reqdata = "type=lead"
    return this.makeapi.method(this.DownloadUrl,reqdata, "downloadfilejsonpostBL")
      .subscribe(res => {
