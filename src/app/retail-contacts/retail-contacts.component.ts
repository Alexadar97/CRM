...
declare var $
@Component({
  selector: 'app-retail-contacts',
  templateUrl: './retail-contacts.component.html',
  styleUrls: ['./retail-contacts.component.css']
})
export class RetailContactsComponent implements OnInit {
  p2 = 1
  ...
  ContactList() {
    // this.loading = true
    var reqdata = "type=" + "contact"+ "&page=" +this.currentPage
  ...
  SearchdataList(value) {
    ...
    var reqdata = "type=" + "contact" + "&searchstr=" + value + "&page=" +this.currentPage
  ...
  showTypes(event) {
    ...
    $("#importActions").slideToggle("fast");

  }
  downloadexcel() {
    var reqdata = "type=contact"
    return this.makeapi.method(this.DownloadUrl, reqdata, "downloadfilejsonpostRC")
      .subscribe(res => {
 ...
 PaginationCountSearch() {
  var getdata = "type="+"contact" +"&searchstr="+ this.Searchval
    return this.makeapi.method(this.Paginationurl, getdata, "post")
      .subscribe(data => {
