...
declare var $
@Component({
  selector: 'app-businessleadmodal',
  templateUrl: './businessleadmodal.component.html',
  styleUrls: ['./businessleadmodal.component.css']
})
export class BusinessleadmodalComponent implements OnInit {
      ...
      return this.makeapi.method(this.Listurl, reqdata, "post")
        .subscribe(data => {
          ...
          if (data.isexists == true) {
            $.notify("Corporate lead already exists", "warn");
          }
            ...
            return this.makeapi.method(this.Geturl, reqdata, "post")
              .subscribe(data => {
                ...
                this.employeename1 = false
                this.clearArray()
                //  this.businessleadcontactform.value.contactpersons = []
  ...
  cancelModal() {
    this.employeename1 = false
    // this.businessleadcontactform.patchValue({
    //   contactpersons:[]
    // })
    this.clearArray()
