...
declare var $
@Component({
  selector: 'app-businesscontactmodal',
  templateUrl: './businesscontactmodal.component.html',
  styleUrls: ['./businesscontactmodal.component.css']
})
export class BusinesscontactmodalComponent implements OnInit {
  ...
  private Listurl = this.Url.appconstant + this.Url.createBusinessContactApi;
  ...
  constructor(private makeapi: WebserviceService, private http: Http, private Url: UrlService, private router: Router, private Formbuilder: FormBuilder) {
    this.BusinessForm = this.Formbuilder.group({
      ...
      "companyemailid": [null, Validators.compose([Validators.required,Validators.pattern(this.emailvalidation)])],
      "gst": "",
      "doorno": "",
      "state": "",
      "country": "",
  ...
  partViewPage: any;
  get projectformdetailes() { return <FormArray>this.BusinessForm.get('contactpersons') }
  addRow(): void {
    this.contactpersons = this.BusinessForm.get('contactpersons') as FormArray;
  ...
  submitBusiness() {
    if (this.BusinessForm.invalid) {
      ...
      var getdata = this.BusinessForm.value
  ...
  clearArray() {
    while (this.projectformdetailes.length != 1) {
      this.projectformdetailes.removeAt(this.projectformdetailes.length - 1)
    }
  }
  cancelModal(){
    this.employeename1 = false
