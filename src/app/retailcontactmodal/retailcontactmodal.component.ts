...
declare var $;
@Component({
  selector: 'app-retailcontactmodal',
  templateUrl: './retailcontactmodal.component.html',
  styleUrls: ['./retailcontactmodal.component.css']
})
export class RetailcontactmodalComponent implements OnInit {
  ...
  constructor(private makeapi: WebserviceService, private http: Http, private Url: UrlService, private router: Router, private Formbuilder: FormBuilder) {
    ...
    this.RetailcontactForm = this.Formbuilder.group({
  ...
  submitRetaillead() {
    var getdata = this.RetailcontactForm.value
    if ((getdata.firstname == null || getdata.firstname == "") && (getdata.email == null || getdata.email == "") &&
      ...
      var reqdatavalue = this.RetailcontactForm
      var getdata = this.RetailcontactForm.value
  ...
  ChangeLeadType(value) {
    ...
    else if (value == 'External Referral' && value == 'Cold Call' && value == 'Advertisement' && value == 'Social Media') {
  ...
  PhoneCode(value) {
    for (var i = 0; i < this.countriesArray.length; i++) {
      if (value == this.countriesArray[i].code) {
        ...
        this.RetailcontactForm.patchValue(getdata)
      }
    }
  }
