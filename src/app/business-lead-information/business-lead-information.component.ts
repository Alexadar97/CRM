...
@Component({
  selector: 'app-business-lead-information',
  templateUrl: './business-lead-information.component.html',
  styleUrls: ['./business-lead-information.component.css']
})
export class BusinessLeadInformationComponent implements OnInit {
      ...
      return this.makeapi.method(this.Activityurl, reqdata, "post")
        .subscribe(data => {
          if (data.status == "success") {
            ...
            $.notify("Please fill all mandatory fields", "warn");
          }
          else {
            $.notify("Please fill all mandatory fields", "error");
          }
